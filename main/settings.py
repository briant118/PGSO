...
SECRET_KEY = 'django-insecure--fy*2^r54f)xpe2c3tlnajuf2m!wz)lt6(hs35%-7bk0(yqmjn'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Allow local network access from other PCs (localhost + any host for dev)
ALLOWED_HOSTS = ["*"]
...
# WhiteNoise: serve static files on Render without nginx
...
# Email (Gmail SMTP for ProfilingSystem)
